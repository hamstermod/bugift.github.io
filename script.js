...
function render(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        t.price = +((t.price + (t.price * 10 / 100)).toFixed(3));
        ...
        button.onclick = function () {
            priceDisplay.innerText = t.price;
